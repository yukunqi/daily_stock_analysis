...
```json
{
    ...
    "dashboard": {
        ...
        "intelligence": {
            ...
            "news_decision_impact": "说明新闻是否改变、强化或削弱本次操作建议；若未改变，也必须说明原因",
...
3. 📊 **业绩预期**：年报预告、业绩快报
4. 🧭 **新闻对决策的影响（强制）**：
   - 必须输出 `news_decision_impact`
   - 说明新闻是“改变了操作建议”“强化了原有结论”“削弱了原有结论”还是“未改变操作建议”
   - 若新闻只是行业层面或相关性较弱，必须明确写出“未改变操作建议/直接催化有限”，不能只复述新闻标题
   - 若新闻与技术面冲突，必须写清楚最终以哪个因素为主，以及触发重新评估的条件
5. 🕒 **时间规则（强制）**：
...
- **新闻决策影响**：`dashboard.intelligence.news_decision_impact` 必须明确说明新闻对本次操作建议的影响，不能只罗列新闻事实
