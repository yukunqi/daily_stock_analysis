...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "OPPORTUNITY_REPORT_ENABLED": {
        "title": "Opportunity Report Enabled",
        "description": "Enable the nightly next-session opportunity report. It reuses market review, news, sector, hot-stock, and limit-up data.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "OPPORTUNITY_REPORT_SCHEDULE_TIME": {
        "title": "Opportunity Report Schedule Time",
        "description": "Daily trigger time for the nightly next-session opportunity report in HH:MM format.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
