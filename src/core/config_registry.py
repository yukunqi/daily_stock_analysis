...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "REALTIME_SOURCE_PRIORITY": {
        ...
        "is_required": False,
        "is_editable": True,
        "default_value": "iwencai_market,tencent,akshare_sina,efinance,akshare_em",
        "options": [],
        "validation": {},
        "display_order": 20,
    },
    ...
    "TREND_RADAR_NEWS_ENABLED": {
        "title": "TrendRadar News Enabled",
        "description": "Read passive news from local TrendRadar SQLite output for stock and market analysis.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TREND_RADAR_OUTPUT_DIR": {
        "title": "TrendRadar Output Directory",
        "description": "Local TrendRadar output directory containing news/YYYY-MM-DD.db files.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "/Users/yukunqi_1/git_project/TrendRadar/output",
        "options": [],
        "validation": {},
        "display_order": 59,
    },
    "TREND_RADAR_NEWS_DAYS": {
        "title": "TrendRadar News Days",
        "description": "Number of recent TrendRadar news database days to read.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TREND_RADAR_NEWS_LIMIT": {
        "title": "TrendRadar News Limit",
        "description": "Maximum TrendRadar news items to read per analysis run.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TREND_RADAR_FETCH_CONTENT_ENABLED": {
        "title": "TrendRadar Fetch Article Content",
        "description": "Fetch article body excerpts for matched TrendRadar URLs before sending context to the LLM.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TREND_RADAR_CONTENT_MAX_ITEMS": {
        "title": "TrendRadar Article Fetch Limit",
        "description": "Maximum matched TrendRadar URLs to fetch per stock analysis.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "NEWS_CONTENT_CACHE_PATH": {
        "title": "News Content Cache Path",
        "description": "SQLite cache path for fetched article text.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "./data/news_content_cache.db",
        "options": [],
        "validation": {},
        "display_order": 64,
    },
    "NEWS_CONTENT_FETCH_TIMEOUT": {
        "title": "News Content Fetch Timeout",
        "description": "HTTP timeout in seconds for fetching article pages.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "NEWS_CONTENT_MAX_CHARS": {
        "title": "News Content Max Characters",
        "description": "Maximum article excerpt characters injected into prompts per fetched URL.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "NEWS_CONTENT_CACHE_TTL_HOURS": {
        "title": "News Content Cache TTL",
        "description": "How long a successful article-content cache entry remains fresh.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
