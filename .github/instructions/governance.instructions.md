---
applyTo: "README.md,docs/**,AGENTS.md,.github/**,.claude/skills/**,scripts/**,docker/**"
---
...
- `AGENTS.md` is the canonical AI collaboration document; if its meaning changes, sync `.github/copilot-instructions.md`, `.github/instructions/*.instructions.md`, and repository skills as needed.
